...
export default function Home() {
  return (
    <main className="flex-grow max-w-screen-xl mx-auto w-full px-6">
      ...
      <section className="my-10 flex flex-wrap justify-center gap-10 h-[34rem] bg-gradient-radial from-red-600/50 via-black to-transparent">
        <div className="w-[30rem] flex flex-col gap-8 justify-center">
          ...
          <Link href="http://www.linkedin.com/in/paolocesarcharcamamani"
            className="flex justify-around items-center w-48 text-xl bg-red-600 p-3 rounded-xl text-center font-bold no-underline hover:scale-105 transition-all duration-500 delay-100"
          >
            <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50">
